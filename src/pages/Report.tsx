...
const Report = function () {
    ...
    return (
        <>
            ...
            <TextMultiline lines={1} name="content" value={report.content} placeholder="Material de referência" onChange={(event) => InputChanger(event, "content")} />
            <TextMultiline lines={3} name="resume" value={report.resume} placeholder="Resumo da aula" onChange={(event) => InputChanger(event, "resume")} />
            <TextMultiline lines={3} name="homework" value={report.homework} placeholder="Diversão de casa" onChange={(event) => InputChanger(event, "homework")} />
            <TextLine name="teacher" value={report.teacher} placeholder="Instrutor(a)" onChange={(event) => InputChanger(event, "teacher")} />
